  ...
  return (
    <Styled.Container>
      ...
      <Styled.CardContainer marginBottom={3}>
        ...
        <Styled.CardText>
          <Typography variant="overline" fontSize="14px">
            One of the first singin forms i have done and for didactic purposes
            only, this application simulates a site from the anime One Piece
            (all rights reserved), you can register a new user, the user datas
            will be saved in browser local storage, and is possible logging in
            to recent create account.
      ...
      <Styled.CardContainer marginBottom={3}>
        ...
        <Styled.CardText>
          <Typography variant="overline" fontSize="14px">
            For didactic purposes only, this application was built during Hiring
            Coders 2021, an event organized by GamaAcademy and VTEX. The
            application consists of a main page build with ReactJs with two
            buttons for registration, one for new customers and another for new
            products generating their respective forms.
            <p>HTML | CSS | React</p>
            <Typography align="right" variant="h6">
              Finished Project
            </Typography>
      ...
      <Styled.CardContainer marginBottom={3}>
        ...
        <Styled.CardText>
          <Typography variant="overline" fontSize="14px">
            Unfortunately, this application is still under development, but its
            purpose is to be used in a car repair shop so that customers can be
            registered, the cars with problems and the entire situation will be
            stored in a database and API service, and it will be possible to
            print the service order of the respective car that entered.
            <p>
